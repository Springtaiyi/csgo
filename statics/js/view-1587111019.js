...
$(function () {
  ...
  function caseOpen(isFast) {
    ...
    function setPrizeData(data) {
      ...
      weapon.type.html(data.weapon.category);
      weapon.img.attr('src', data.weapon.image + winImgSuffix);
      weapon.name.html(stattrakPrefix(data.weapon.stattrak, ' ') + data.weapon.name);
      weapon.title.html(data.weapon.title);
      weapon.price.html(data.weapon.price);
